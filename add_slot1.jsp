...
<body>
    ...
    <main>
        ...
        <div class="container p-3 my-3 border" style="background-color:#e0e0e0; margin-top: -3rem;">
            <div class="row">
                <div class="col">
                    Select Date: <div id="datepicker"></div>
                </div>
                <div class="col">
                    Choose one Court:
                    <ul class="ks-cboxtags">
                        <li><input type="checkbox" id="checkboxOne" value="Rainbow Dash" class="chb"><label for="checkboxOne">Court 1 (Tennis)</label></li>
                        <li><input type="checkbox" id="checkboxTwo" value="Cotton Candy" class="chb"><label for="checkboxTwo">Court 2 (Tennis)</label></li>
                        <li><input type="checkbox" id="checkboxThree" value="Rarity" class="chb"><label for="checkboxThree">Court 3 (Basketball)</label></li>
                        <li><input type="checkbox" id="checkboxFour" value="Moondancer" class="chb"><label for="checkboxFour">Court 4 (Basketball)</label></li>
                        <li><input type="checkbox" id="checkboxFive" value="Surprise" class="chb"><label for="checkboxFive">Court 5 (Basketball)</label></li>				  
                        <li><input type="checkbox" id="checkboxEight" value="Derpy Hooves" class="chb"><label for="checkboxEight">Court 6 (Padel)</label></li>					  
                    </ul>
                </div>
                <div class="col">
