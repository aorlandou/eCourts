...
<body class="form-v10">
	...
	<div class="page-content">		
		...
		<div class="form-v10-content">
			...
			<form class="form-detail"  id="myform" action="user_profile.html" method="post" onsubmit="valthisform()">
					...
					<div class="">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                              <h4>Dimitris Bouris</h4>
                              <p class="text-secondary mb-1"></p>
                              <p class="text-muted font-size-sm">Krystalli 40A, Agios Stefanos</p>
				...
				<div class="form-right" >
                    ...
                    <div class="form-group">
						<div class="form-row form-row-1">
							...
							<br>
							<input  type="text" name="email" oninput='check8();' style="width: 250px;" class="company" id="email" placeholder="Password" value="bourisd2@gmail.com">
							<span id='message_email'></span>	
						</div>
						<div class="form-row form-row-2">
							<label class="text-muted">Phone</label>
							<br>
							<input   type="text" name="phone" oninput='check7();' style="width: 250px;"  id="phone" autocomplete="off" class="input-text" placeholder="Surname" value="6946933279">
					...
					<div class="form-group">
						...
						<br>
						<input  type="password" name="password" oninput='check();' style="width: 250px;" class="password" id="password"  value="123456789">	
						<span id='message_pass1'></span>					
						</div>
						<div class="form-row form-row-2">
							<label class="text-muted">Confirm Password</label>
						<br>
						<input  type="password" name="confirm" style="width: 250px;" oninput='check();' class="confirm" id="confirm"  value="123456789">	
					...
					<div class="form-group">
						<div class="form-row form-row-1">
							...
							<br>
							<input type="text" name="street" style="width: 250px;" id="street" autocomplete="off" class="input-text"  value="Dimitris">
                            
						</div>
						<div class="form-row form-row-2">
							<label class="text-muted">Number</label>
							<br>
							<input    type="text" name="street_number" style="width: 250px;" id="street_number" autocomplete="off" class="input-text"  value="Bouris">
					...
					<div class="form-group">
						<div class="form-row form-row-1">
							...
							<br>
							<input type="text" name="zip" oninput='check6();' style="width: 250px;" id="zip" autocomplete="off" class="input-text" value="Dimitris">
                            <span id='message_zip'></span>	
						</div>
						<div class="form-row form-row-2">
							<label class="text-muted">Town</label>
							<br>
							<input    type="text" name="town" style="width: 250px;" id="town" autocomplete="off" class="input-text" value="Bouris">
