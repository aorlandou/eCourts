    ...
    public Customer customerDetails(int userID) throws Exception{
        ...
        public int register(){
            ...
            {  
                ...
                pstmt=con.prepareStatement("INSERT INTO users(email,phone,password,name,street,street_number,munic_id,zipcode,date_registered,type,municipality) VALUES (?,?,?,?,?,?,?,?,?,?,?);");
                ...
                pstmt.setString(6,super.getStreet_number()); 
                pstmt.setInt(7,1);    
                pstmt.setString(8,super.getZip_code()); 
                pstmt.setString(9,super.getRegister_date());                 
                pstmt.setInt(10,0);   
                pstmt.setString(11,super.getTown()); 
                pstmt.executeUpdate();  
